...
{
    public static class _18MaximumPathSumI
    {
        ...
        private const string Triangle = @"75
95 64
17 47 82
18 35 87 10
20 04 82 47 65
...
04 62 98 27 23 09 70 98 73 93 38 53 60 04 23";
        ...
        {
            var triangle = Triangle.Split(Environment.NewLine).Select(s => s.Split(" ").Select(t => double.Parse(t)).ToArray()).ToArray();
